...
function renderPdfPreview() {
    ...
    const header = `
        ...
        ${o.show_school ? `<div class="pv-brand">AI Generated by VoQuiz</div>` : ""}
...
function applyTheme(theme) {
    ...
    const logo = (theme === "dark" ? "VoQuiz_Logo_Dark.png" : "VoQuiz_Logo_Light.png") + "?v=4";
